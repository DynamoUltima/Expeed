      ...
      */}
      ...
      <div className="divide-y divide-black divide-opacity-25">
        <div className="flex flex-row justify-between p-2 items-center">
          <div className="font-bold ">Expeed</div>

          <form action="" className=" " >
            <div className="flex items-center ring-2 ring-gray-400 bg-white rounded-xl border-b border-gray-200 w-96 outline-none shadow-none">
